...
OUT = ROOT / 'research/benchmarks/login_combinations_v1'
...
def sample(x, env, virtual=False):
    ...
    if virtual:
        events = [dict(code='Unidentified', type='down', t=500., field='password', trusted=True),
                  dict(code='Unidentified', type='up', t=550., field='password', trusted=True)]
