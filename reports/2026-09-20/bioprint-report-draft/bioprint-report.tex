...
\end{center}
Run \texttt{bash experiments/typing\_demo/run.sh} from the repository root. The script checks model use, saved-score agreement and session issuance, then opens a local browser report. It requires no live accounts or network listener.
