"""Synthetic CPU training-cost probe of pinned author BehaveFormer code.
...
OUT = ROOT / 'research/benchmarks/references/hmog/behaveformer_cpu_training_probe.json'
...
def run():
    ...
    report = {'scope': 'Generated tensors only; no real measurements, checkpoints, identity selection or accuracy evaluation',
              ...
              'rough_compute_extrapolation': {'epochs': 20, 'batches_per_epoch': 40,
                    ...
                    'caveat': 'Illustrative compute only for8triplets perstep; excludes preprocessing, validation, I/O and contention changes. Not author full64triplet schedule and not an accuracy prediction.'},
